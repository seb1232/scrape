    ...
    try:
        ...
        for board, cards in boards.items():
            ...
            for c in cards:
                ...
                training_context += f"[{c['column']}] {c['text']}{date_info}\n"
        ...
        try:
            ...
            print("✅ AI trained with all feedback data from all boards!")
            ai_trained = True
        except Exception as e:
        ...
        while True:
            ...
            if ai_trained:
                ...
                answer = analyze_feedback_question_fallback(all_cards, question)
...
11. Scrape all boards and train AI
""")
    ...
    if option == '8':
        ...
        scrape_all_boards_and_train_ai()
    else:
