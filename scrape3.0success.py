...
def setup_ollama_model():
    ...
    try:
        ...
        ollama.pull('llama3.2:1b')  # Using smaller model for faster responses
...
def analyze_feedback_with_ollama(cards, question):
    ...
    try:
        ...
        for i, card in enumerate(cards, 1):
            ...
            context += f"{i}. [{card['column']}]{date_info}: {card['text']}\n"
...
""")
    ...
    if option == '8':
        ...
        if ollama_ready:
            print("✅ AI analysis ready! You can now ask complex questions about your feedback.")
        else:
            print("⚠️ AI analysis unavailable, using fallback analysis system.")
        ...
        while True:
            ...
            if question.lower() == 'exit':
                ...
                try:
                    ...
                    print("⚠️ Training failed, but you can still ask questions.")
                continue
